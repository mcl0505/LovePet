...
class HomeFragment :
    BaseFragment<FragmentHomeBinding, HomeViewModel>(R.layout.fragment_home, BR.viewModel) {
            ...
            mBinding.homeTopBg.setShapeDrawable {
                shape {
                    ...
                    addGradient(
                        ...
                        gradientType = GradientDrawable.Orientation.TOP_BOTTOM
                    )
                }
...
//                    })
                ...
                override fun onPageSelected(position: Int) {
                    getPaletteColor(bannerList[position]) { mPalette ->
                        val startColor =
                            mPalette.getLightVibrantColor(R.color.color_white.getColor())
